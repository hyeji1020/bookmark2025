...
function RegistForm({ toggleLogin }: ToggleLoginProps) {
  ...
  return (
    <form action={register} className=''>
      ...
      <Button type='submit' className='w-full mt-3 bg-slate-200 text-black'>
        Sign up
      </Button>
      ...
      <div className='mt-3'>
        ...
        <Button
          onClick={toggleLogin}
          variant={'link'}
          className='ml-2 bg-sky-200 text-black'
        >
          Sign in
        </Button>
      </div>
  ...
  return (
    <form className=''>
      ...
      <div className='flex justify-between my-2'>
        <label className='cursor-pointer hover:text-sky-400'>
          <input type='checkbox' className='mr-1 translate-y-[1px]' />
          Remember me
        </label>
        <a href='#'>Forgot password?</a>
      </div>
      <Button className='w-full bg-slate-300 text-black'>
